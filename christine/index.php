...
<div class="row">
    <h2 class="name-header">Christine's Picks</h2>
    <div class="list-group">
        
        <div class="list-group-item">
            <h3>Consumed</h3>
            <h4>by David Cronenberg</h4>
            <p>The exhilarating debut novel by iconic filmmaker David Cronenberg: the story of two journalists whose entanglement in a French philosopher’s death becomes a surreal journey into global conspiracy.</p>
            <p>Stylish and camera-obsessed, Naomi and Nathan thrive on the yellow journalism of the social-media age. They are lovers and competitors—nomadic freelancers in pursuit of sensation and depravity, encountering each other only in airport hotels and browser windows.</p>
            <p>Naomi finds herself drawn to the headlines surrounding Célestine and Aristide Arosteguy, Marxist philosophers and sexual libertines. Célestine has been found dead and mutilated in her Paris apartment. Aristide has disappeared. Police suspect him of killing her and consuming parts of her body. With the help of an eccentric graduate student named Hervé Blomqvist, Naomi sets off in pursuit of Aristide. As she delves deeper into Célestine and Aristide's lives, disturbing details emerge about their sex life—which included trysts with Hervé and others. Can Naomi trust Hervé to help her?</p>
            <p>Nathan, meanwhile, is in Budapest photographing the controversial work of an unlicensed surgeon named Zoltán Molnár, once sought by Interpol for organ trafficking. After sleeping with one of Molnár’s patients, Nathan contracts a rare STD called Roiphe’s. Nathan then travels to Toronto, determined to meet the man who discovered the syndrome. Dr. Barry Roiphe, Nathan learns, now studies his own adult daughter, whose bizarre behavior masks a devastating secret.</p>
            <p>These parallel narratives become entwined in a gripping, dreamlike plot that involves geopolitics, 3-D printing, North Korea, the Cannes Film Festival, cancer, and, in an incredible number of varieties, sex. Consumed is an exuberant, provocative debut novel from one of the world’s leading film directors.</p>
